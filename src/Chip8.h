 ...
 * This class provides a nice abstraction of the chip-8 system as a whole, and if this project was ever to be used as a library for another
 * project,
 * this would likely be the API that would be exposed to external projects.
 * Currently, this class basically instantiates all necessary dependencies, but in the future, if there are multiple implementations of
